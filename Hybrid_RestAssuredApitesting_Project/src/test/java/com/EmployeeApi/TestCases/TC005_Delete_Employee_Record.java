...
public class TC005_Delete_Employee_Record extends Testbase1
{
	RequestSpecification HttpRequest;
	 ...
	 @BeforeTest
		public void getAllEmployeesDetails() throws InterruptedException
		{
			...
			String emId=jsonPathEvaluator.get("[0].id");
			response=HttpRequest.request(Method.DELETE,"/delete/"+emId);
	...
	{
		logger.info("*******************TC005_Delete_Employee_Record FINISHED*****************");
	}
}
